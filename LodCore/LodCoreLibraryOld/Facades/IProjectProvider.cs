...
namespace LodCoreLibraryOld.Facades
{
    public interface IProjectProvider
    {
        ...
        List<Project> GetProjects(int projectsToSkip, int projectsToReturn,
        ...
        void AddUserToProject(int projectId, int userId, string role, string firstName, string lastName,
            string projectName);
