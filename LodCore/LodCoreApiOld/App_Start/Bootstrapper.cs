...
using LodCoreLibraryOld.Infrastructure.DataAccess;
...
namespace LodCoreApiOld
{
    public class Bootstrapper
    {
        public Container Configure()
        {
            ...
            container.Register<INumberOfNotificationsProvider>(() => container.GetInstance<EventRepository>(),
                Lifestyle.Singleton);
            ...
            container.Register<INotificationService>(() =>
                new LodCoreLibraryOld.Domain.NotificationService.NotificationService(
            ...
            container.Register<IAuthorizer>(() => new Authorizer(
                    TimeSpan.FromSeconds(
                        int.Parse(ConfigurationManager.AppSettings["Authorizer.TokenLifeTimeInSeconds"])),
                    container.GetInstance<IUserRepository>()),
                Lifestyle.Singleton);
            ...
            container.RegisterCollection<IEventSink>(new[]
            {
                typeof(UserManagementEventSink<>).Assembly,
            ...
            container.Register<IEventPublisherProvider>(() => container.GetInstance<EventConsumersContainer>(),
                Lifestyle.Singleton);
            container.Register(() => container.GetInstance<IEventPublisherProvider>()
        ...
        private static void RegisterSettings(Container container)
        {
            ...
            container.Register(() => SettingsReader.ReadRelativeEqualityComparerSettings(settings),
                Lifestyle.Singleton);
        ...
        private static void RegisterEventConsumers(Container container)
        {
            ...
            consumersContainer.RegisterConsumer(container
                .GetInstance<UserManagementEventSink<NewEmailConfirmedDeveloper>>());
            consumersContainer.RegisterConsumer(container
                .GetInstance<UserManagementEventSink<NewFullConfirmedDeveloper>>());
